...
const BookItem = ({book}) => { //, onBookSelect
  ...
  return (
    <li class="list-group-item" style={{float:'left', position: 'relative', width: '200px', height:'300px'}}>
      ...
      <span class="glyphicon glyphicon-remove pull-right" aria-label="true" style={{ position: 'absolute', zIndex:'3', right:'10px', top:'10px', color:'#e50000', fontSize:'20px', textShadow: '0px 0px 7px white', WebkitTextStroke: '1px black' }}/>
